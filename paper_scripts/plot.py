...
'1.csv' :{'label':'1st-row(He)', 'color':'#0099ff', 'fmt':'o', 'linestyle':'--','dashes': (3,1)},
'2.csv' :{'label':'2nd-row(Ne)', 'color':'#00cc00', 'fmt':'D', 'linestyle':'--','dashes': (6,2)},
'3.csv' :{'label':'K-Zn(Ne)',    'color':'#ff9933', 'fmt':'X', 'linestyle':'--','dashes': (1,1)},
'4.csv' :{'label':'2nd-row(He)', 'color':'#ff0000', 'fmt':'*', 'linestyle':'--','dashes': (1,1,8,1)},
...
def init():
	...
	legend = {'frameon':False, 'fontsize':13, 'handlelength':2.00, 'labelspacing':0.20}
...
fig,ax = init()
ax.set_xlabel('Valence electron number')
