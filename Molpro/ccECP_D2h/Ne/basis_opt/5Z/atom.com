...
spar=[0.318678, 2.605133]
ppar=[0.218226, 2.918630]
dpar=[0.654924, 2.949200]
fpar=[1.314297, 3.093614]
gpar=[2.070925, 2.900000]
hpar=[3.743118, 1.000000]
...
s,Ne,sexp(1),sexp(2),sexp(3),sexp(4)
p,Ne,pexp(1),pexp(2),pexp(3),pexp(4)
d,Ne,dexp(1),dexp(2),dexp(3),dexp(4)
f,Ne,fexp(1),fexp(2),fexp(3)
g,Ne,gexp(1),gexp(2)
h,Ne,hexp(1)
}
...
{minimize,eval,spar(1),spar(2),ppar(1),ppar(2),dpar(1),dpar(2),fpar(1),fpar(2),gpar(1),gpar(2),hpar(1)
