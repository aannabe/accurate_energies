...
spar=[0.059278, 2.115879]
ppar=[0.025756, 2.179463]
dpar=[0.078652, 1.987781]
fpar=[0.175674, 1.978919]
gpar=[0.295545, 1.981278]
hpar=[0.538526, 1.984699]
ipar=[1.080470, 2.000000]
...
s,Ga,sexp(1),sexp(2),sexp(3),sexp(4),sexp(5)
p,Ga,pexp(1),pexp(2),pexp(3),pexp(4),pexp(5)
d,Ga,dexp(1),dexp(2),dexp(3),dexp(4),dexp(5)
f,Ga,fexp(1),fexp(2),fexp(3),fexp(4)
g,Ga,gexp(1),gexp(2),gexp(3)
h,Ga,hexp(1),hexp(2)
i,Ga,iexp(1)
}
