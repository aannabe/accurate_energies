...
spar=[0.111564 1.858683]
ppar=[0.086454 2.330481]
dpar=[0.197812 2.211129]
fpar=[0.269910 1.985304]
gpar=[0.458050 2.237956]
hpar=[0.849669 2.000000]
...
s,Br,sexp(1),sexp(2),sexp(3),sexp(4)
p,Br,pexp(1),pexp(2),pexp(3),pexp(4)
d,Br,dexp(1),dexp(2),dexp(3),dexp(4)
f,Br,fexp(1),fexp(2),fexp(3)
g,Br,gexp(1),gexp(2)
h,Br,hexp(1)
}
