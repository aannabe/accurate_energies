...
spar=[0.124188, 2.261279]
ppar=[0.086016, 2.701289]
dpar=[0.205619, 2.531351]
fpar=[0.288308, 2.497250]
gpar=[0.591225, 2.000000]
...
s,Se,sexp(1),sexp(2),sexp(3)
p,Se,pexp(1),pexp(2),pexp(3)
d,Se,dexp(1),dexp(2),dexp(3)
f,Se,fexp(1),fexp(2)
g,Se,gexp(1)
}
