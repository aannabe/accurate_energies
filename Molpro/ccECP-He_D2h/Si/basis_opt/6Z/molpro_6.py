...
param0=np.array([
 ...
 2.039960 , #Lowest s exponent
 1.997652 , #Ratio for s exponents
 3.077427 , #Lowest p exponent
 2.074699 , #Ratio for p exponents
 3.897419 , #Lowest d exponent
 1.730000 , #Ratio for d exponents
 3.507112 , #Lowest f exponent
 2.002250 , #Ratio for f exponents
 4.626176 , #Lowest g exponent
 2.176201 , #Ratio for g exponents
 7.427265 , #Lowest h exponent
 2.385919 , #Ratio for h exponents
12.571789 , #Lowest i exponent
