...
dm=hf.init_guess_by_chkfile('/home/gani/repos/chk_files/Pyscf/Ni_pp.chkfile')
en=hf.kernel(dm)
#en=hf.kernel()
#hf.mulliken_pop()
#hf.analyze()
...
weights = [1.0/10, 1.0/10, 1.0/10, 1.0/10, 1.0/10, 1.0/10, 1.0/10, 1.0/10, 1.0/10, 1.0/10]
#print(weights)
...
mc = mcscf.CASSCF(hf, 5, (5,3))
cas_list = [5,6,7,9,10] # pick orbitals for CAS space, 1-based indices
